...
use App\Filament\Resources\BusinessCategories\Pages\BusinessCategoryManagement;
...
use App\Filament\Resources\BusinessCategories\Pages\ViewBusinessCategory;
use App\Filament\Resources\BusinessCategories\Schemas\BusinessCategoryForm;
use App\Filament\Resources\BusinessCategories\Schemas\BusinessCategoryInfolist;
...
class BusinessCategoryResource extends Resource
{
    ...
    {
        return BusinessCategoryInfolist::configure($schema);
    }
    ...
    {
        return [
            'index' => BusinessCategoryManagement::route('/'),
            'list' => ListBusinessCategories::route('/list'),
            'create' => CreateBusinessCategory::route('/create'),
            'view' => ViewBusinessCategory::route('/{record}'),
