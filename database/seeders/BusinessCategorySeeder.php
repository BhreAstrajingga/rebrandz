...
class BusinessCategorySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $categories = [
            ...
            ['name' => 'Food & Beverage', 'description' => 'Restaurants, cafes, catering, and food production.'],
            ...
            ['name' => 'Beauty & Personal Care', 'description' => 'Salons, cosmetics, skincare, and wellness.'],
            ['name' => 'Health & Fitness', 'description' => 'Gyms, trainers, and wellness programs.'],
            ['name' => 'Healthcare & Medical', 'description' => 'Clinics, dental, labs, and medical services.'],
            ...
            ['name' => 'Automotive Parts & Service', 'description' => 'Parts, accessories, and maintenance services.'],
            ['name' => 'Construction', 'description' => 'Builders, contractors, and materials.'],
            ['name' => 'Architecture & Engineering', 'description' => 'Design, engineering, and technical services.'],
            ['name' => 'Real Estate', 'description' => 'Property sales, rentals, and management.'],
            ['name' => 'Hospitality & Tourism', 'description' => 'Hotels, guesthouses, and tourist services.'],
            ['name' => 'Travel Agency', 'description' => 'Travel planning and tour operators.'],
            ['name' => 'Logistics & Transportation', 'description' => 'Shipping, courier, and freight services.'],
            ...
            ['name' => 'Internet & Software (SaaS)', 'description' => 'Web, mobile apps, and SaaS products.'],
            ['name' => 'Telecommunications', 'description' => 'Network, ISP, and communication services.'],
            ['name' => 'Finance & Accounting', 'description' => 'Accounting, taxation, and financial services.'],
            ...
            ['name' => 'Events & Wedding', 'description' => 'Event planners, venues, and vendors.'],
            ['name' => 'Entertainment', 'description' => 'Games, cinemas, and performers.'],
            ['name' => 'Sports & Recreation', 'description' => 'Clubs, activities, and facilities.'],
            ['name' => 'Home & Garden', 'description' => 'Home improvement and gardening.'],
            ['name' => 'Furniture', 'description' => 'Home and office furniture.'],
            ['name' => 'Electronics & Appliances', 'description' => 'Consumer electronics and appliances.'],
            ['name' => 'Office Supplies', 'description' => 'Stationery and office equipment.'],
            ['name' => 'Printing & Packaging', 'description' => 'Print shops and packaging services.'],
            ...
            ['name' => 'Pets & Veterinary', 'description' => 'Pet shops and veterinary services.'],
            ['name' => 'Art & Design', 'description' => 'Studios, galleries, and design services.'],
            ['name' => 'Photography & Videography', 'description' => 'Photo, video, and production.'],
            ['name' => 'Consulting', 'description' => 'Business and management consulting.'],
            ['name' => 'Agriculture', 'description' => 'Farming and agri-products.'],
            ['name' => 'Utilities & Energy', 'description' => 'Power, water, and renewables.'],
            ['name' => 'Repair & Maintenance', 'description' => 'Electronics, home, and equipment repairs.'],
            ['name' => 'Jewellery & Accessories', 'description' => 'Jewellery design and retail.'],
            ['name' => 'Children & Baby', 'description' => 'Toys, clothing, and services for kids.'],
